...
equity.list <- read.csv(file="Equity.csv", sep = ";", header = TRUE)
...
msci <- read.csv(file="msci_latest.csv", sep = ";", header = TRUE)
...
data.str <- read.csv(file="Strat_series.csv", sep = ';', header = TRUE)
